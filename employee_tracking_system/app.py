...
# Sitting/standing threshold
SITTING_THRESHOLD = 0.8  # Adjust based on experiments
    ...
    for obj in tracked_objects:
        ...
        if person_crop.size > 0:
            ...
            if results.pose_landmarks:
                ...
                overlay_color = (255, 0, 0) if position == "Sitting" else (0, 255, 0)
                ...
                cv2.putText(frame, f"S: {timers[obj_id]['sitting_time']:.1f}s | St: {timers[obj_id]['standing_time']:.1f}s",
